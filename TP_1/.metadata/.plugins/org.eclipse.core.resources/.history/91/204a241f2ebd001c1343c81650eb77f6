...
//funcion dentro del switch
			...
			switch(opcion)
	{
		...
		case 3:
			...
			utn_Bitcoin(precioAerolineas, precioBitcoin, &precioAerolineasBitcoin);
			utn_Bitcoin(precioLatam, precioBitcoin, &precioLatamBitcoin);
		...
		case 4:
				if(seIngresaronPrecios)
				{
					...
					printf("Pagando con tarjeta de crédito tiene un valor : %.2f $\n",recargoLatam);
